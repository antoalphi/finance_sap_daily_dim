...
The 'finance_sap_daily_dim' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/finance_sap_daily_dim/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] finance_sap_daily_dim_etl` to your workspace.
